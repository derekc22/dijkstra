...
public class DijkstraAlgorithm  {
    ...
    public void initDijkstraNodes(){
        ...
        for (DijkstraNode node : dijkstraNodeList){
            node.pathToArr = new int[dijkstraNodeList.size()];
        }
    ...
    public void dijkstra(DirectedGraph graph, int originNodeNum){
        ...
        for (DijkstraNode node : dijkstraNodeList){
            System.out.println("Path from " + originNodeNum + " to " + node.number);
            printPath(node.number, 1);

            System.out.println();
            System.out.println("Total Distance: " + calculateTotalDist(node.number,  0));
            System.out.println();
        }
